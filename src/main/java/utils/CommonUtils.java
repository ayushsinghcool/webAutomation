...
public class CommonUtils {
    ...
    public static void captureScreenWeb(ExtentTest node, String details){
        try{
            node.info(details,MediaEntityBuilder.createScreenCaptureFromPath(Screenshot.captureScreenWeb()).build());
        }catch (Exception e){
